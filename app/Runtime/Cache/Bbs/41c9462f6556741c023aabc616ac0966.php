...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><section class="am-panel am-panel-default bbs">
	        <div class="am-panel-hd"><?php echo ($data["title"]); ?></div>
	          <pre class="content"><?php echo ($data["content"]); ?></pre>
	</section><?php endforeach; endif; else: echo "" ;endif; ?>


<?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data2): $mod = ($i % 2 );++$i;?><section class="am-panel am-panel-default bbs">
