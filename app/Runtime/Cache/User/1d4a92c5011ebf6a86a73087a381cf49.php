...
<div class="am-g">
  <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
    ...
    <form action="<?php echo U('Signup/check');?>" method="post" class="am-form">
      ...
      <img src="<?php echo U('Login/verify');?>" height="40px" width="130px" />
      <br>
      <br />
      <div class="am-cf">
        <input type="submit" name="" value="登 录" class="am-btn am-btn-success am-btn-sm am-fl">
        <a href="<?php echo U('Login/index');?>" class="am-btn am-btn-default am-btn-sm am-fr"> 已有账号？点击登陆</a>
      </div>
    </form>
    <hr>
