...
<div id="foot">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <input type="hidden" name="wlanuserip" id="wlanuserip" value="223.78.108.136"/>
        <input type="hidden" name="wlanacname" id="wlanacname" value="0006.0535.531.00"/>
        <input type="hidden" name="wlanparameter" id="wlanparameter" value="d071abff0f40bd657340c5f83b51b2773ccb9f889c4ce9c0"/>
	...
	<input type='hidden' name='CSRFToken_HW' value='220b96858c01f8e0429c4b639518351d' /></form>
</body>

<script type="text/javascript">
    if ("pc" == 'pc')
    {
        WlanReportNet.reportNet('223.78.108.136', '2016-08-02 22:08:38:435');
    }
</script>
